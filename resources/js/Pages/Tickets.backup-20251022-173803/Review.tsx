...
export default function Review({
    ...
    const handleFilter = () => {
        ...
        router.get(route("tickets.review.index"), params, {
    ...
    const handleClearFilters = () => {
        ...
        setDateFrom("");
        setDateTo("");
        router.get(route("tickets.review.index"));
    };
            ...
            header={
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 shadow-lg shadow-green-500/20">
                    ...
                    <CardContent className="p-0">
                        {tickets.data.length === 0 ? (
                            <div className="flex flex-col items-center justify-center py-16 text-center">
                                <CheckCircle2 className="mb-4 h-16 w-16 text-gray-300" />
                                <h3 className="mb-2 text-lg font-semibold text-gray-900">
                                    Nenhum ticket em revisão
                                </h3>
                                <p className="text-sm text-gray-500">
                                    Não há tickets aguardando aprovação no
                                    momento.
                                </p>
                            </div>
                        ) : (
