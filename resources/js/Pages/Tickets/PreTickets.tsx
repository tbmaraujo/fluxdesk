...
export default function PreTickets({
    ...
    const handleSearch = (value: string) => {
        ...
        router.get(route("tickets.pre-tickets.index"), params, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    const handlePageChange = (page: number) => {
        router.get(
            route("tickets.pre-tickets.index", {
                ...filters,
                page,
            }),
            {},
    ...
    const handleClearFilters = () => {
        ...
        setSearchTerm("");
        router.get(route("tickets.pre-tickets.index"));
    };
    ...
    const handleExportCsv = () => {
        ...
        const url = route("tickets.pre-tickets.export") + (params.toString() ? `?${params.toString()}` : "");
