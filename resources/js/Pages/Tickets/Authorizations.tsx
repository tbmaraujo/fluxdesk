...
export default function Authorizations({
    ...
    const handleSearch = (value: string) => {
        ...
        router.get(route("tickets.authorizations.index"), params, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    const handlePageChange = (page: number) => {
        router.get(
            route("tickets.authorizations.index", {
                ...filters,
                page,
            }),
            {},
    ...
    const handleClearFilters = () => {
        ...
        setSearchTerm("");
        router.get(route("tickets.authorizations.index"));
    };
    ...
    const handleExportCsv = () => {
        ...
        const url = route("tickets.authorizations.export") + (params.toString() ? `?${params.toString()}` : "");
    ...
    return (
        <AuthenticatedLayout user={auth.user}>
            <Head title="Autorizações Pendentes" />
